...
/* combine 5 datasets in to one dateset called HW5louprojects*/ 
data HW5.Hw5louprojects(label = "Cleaned and Combined EPA Projects Data");
  set hw4.loulead hw5.louso2 hw5.loutsp hw5.louco hw5.louo3;
run;
